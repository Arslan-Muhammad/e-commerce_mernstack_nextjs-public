          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <div className="mt-3 flex select-none flex-wrap items-center gap-1">
              <label className="">
                ...
                <span className="mt-1 block text-center text-xs">$3</span>
              </label>
              <label className="">
                <input
                  type="radio"
                ...
                <span className="mt-1 block text-center text-xs">$5</span>
              </label>
              <label className="">
                <input
                  type="radio"
                ...
                <span className="mt-1 block text-center text-xs">$8</span>
              </label>
            </div>
