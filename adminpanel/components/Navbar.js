...
import { adminLogout } from '../pages/api/api';
...
const Navbar = () => {
    ...
    return (
        <>
            <header className="antialiased sticky top-0 z-20">
                    ...
                    <div className="flex flex-wrap justify-between items-center">
                        <div className="flex justify-start items-center">
                            <button
                                ...
                                type="button"
                                className="inline-flex items-center p-2 mt-2 mr-1 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                            >
                            ...
                            <Link href="/" className="flex mr-4">
                                <img
                                    src="https://img.freepik.com/premium-vector/man-avatar-profile-round-icon_24640-14044.jpg"
                                    className="mr-3 h-8"
                                    alt="Logo"
                                />
                                ...
                                >
                                    <li>
                                        <button
                                            ...
                                            className="py-2 w-full text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                        >
                                            Sign out
                                        </button>
                                    </li>
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <button
                                type="button"
                                className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                                aria-controls="dropdown-example-marketing"
                                data-collapse-toggle="dropdown-example-marketing"
                            >
                                <svg
                                    className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                    aria-hidden="true"
                            ...
                            <ul id="dropdown-example-marketing" className="hidden py-2 space-y-2">
                                <li>
                                    <Link
                                        href="/coupon"
                                        className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-400 hover:shadow-md dark:text-white dark:hover:bg-gray-700"
                        ...
                        <li>
                            <button
                                type="button"
                                className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                                aria-controls="dropdown-example-blog"
                                data-collapse-toggle="dropdown-example-blog"
                            >
                                <svg
                                    className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                    aria-hidden="true"
                            ...
                            <ul id="dropdown-example-blog" className="hidden py-2 space-y-2">
                                <li>
                                    <Link
                                        href="/products"
                                        className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-400 hover:shadow-md dark:text-white dark:hover:bg-gray-700"
