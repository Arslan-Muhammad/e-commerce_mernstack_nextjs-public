...
import { getBrandById, updateBrand } from "@/pages/api/api";
  ...
  return (
    <section className="bg-white dark:bg-gray-900 p-4 sm:ml-64">
      ...
      <div className="px-4 mx-auto max-w-full">
        ...
        <div className="items-center w-full px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
          <Link href="/brands">Close</Link>
        </div>
      </div>
    </section>
  );
